  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify list hygiene checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify reintroduction sequence with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify offer planning board with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify unsubscribe-safe copy notes with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
