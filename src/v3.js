export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Ethical Email Reactivation Kit",
        "Operational table: Email sequence plan",
    ...
    "releaseChecklist": [
        ...
        "Consent Health reaches production threshold",
        "Sequence Readiness is documented with evidence",
        "Frequency Safety has no unresolved blocker",
        "Email sequence verified",
        "Subject lines verified",
